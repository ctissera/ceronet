...
<td class="sf_admin_date sf_admin_list_td_fechainicio">
  <?php echo false !== strtotime($ofertas->getFechainicio()) ? format_date($ofertas->getFechainicio(), "f") : '&nbsp;' ?>
</td>
<td class="sf_admin_date sf_admin_list_td_fechafin">
  <?php echo false !== strtotime($ofertas->getFechafin()) ? format_date($ofertas->getFechafin(), "f") : '&nbsp;' ?>
</td>
<td class="sf_admin_text sf_admin_list_td_imagen">
  <?php echo $ofertas->getImagen() ?>
</td>
